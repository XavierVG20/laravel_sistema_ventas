                ...
                <template v-else-if="listado==0">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-xs-12">
                                <a @click="ocultarDetalle()" class="btn btn-default"><i class="fa fa-close"></i>
                                    Cerrar</a>
                                <button type="button" class="btn btn-success pull-right" @click="registrarIngreso()"><i
                                        class="fa fa-credit-card"></i> Registrar Compra
                                </button>
