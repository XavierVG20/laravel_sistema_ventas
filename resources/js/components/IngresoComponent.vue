            ...
            <div class="box-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-xs-12">
                        ...
                        <button type="button" class="btn btn-success pull-right" @click="registrarIngreso()"><i class="fa fa-credit-card"></i> Registrar Compra
                        </button>
                    ...
                    <div class="table-responsive col-md-12">
                        <table class="table table-bordered table-striped table-sm">
                            ...
                            <tbody v-if="arrayDetalle.length">
                                ...
                                <tr style="background-color: #CEECF5;">
                                    <td colspan="3" ><strong>Total Impuesto:</strong></td>
