                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <label v-if="errors.direccion" class="text-danger">*
                                            {{errors.direccion[0]}}</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <label v-if="errors.tipo_documento" class="text-danger">*
                                            {{errors.tipo_documento[0]}}</label>
    ...
    export default {
        ...
        methods: {
            ...
            async registrarPersona() {
                ...
                try {
                    await axios.post("/cliente/resgistrar", {
                        nombre: this.nombre,
            ...
            async actualizarPersona() {
                ...
                try {
                    await axios.put("/cliente/actualizar", {
                        nombre: this.nombre,
                        tipo_documento: this.tipo_documento,
                        num_documento: this.num_documento,
                        direccion: this.direccion,
