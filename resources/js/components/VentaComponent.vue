                    ...
                    <div class="col-md-6">
                      <div>
                        <tr>
                          ...
                          <th>
<input type="text" v-model="buscar" @keyup.enter="listarVenta(1,buscar,criterio)" class="form-control" placeholder="Texto a buscar">                          </th>
                          <th>
            ...
            <div class="box-body">
                    ...
                    <div class="col-xs-12">
                        <a  @click="ocultarDetalle()"  class="btn btn-default"><i class="fa fa-close"></i> Cerrar</a>
                        <button type="button" class="btn btn-success pull-right" @click="registrarVenta()"><i class="fa fa-credit-card"></i> Registrar Compra
                        </button>
